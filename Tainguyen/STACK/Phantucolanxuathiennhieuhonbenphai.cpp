...
// ta nhận được kết quả ans[] = {-1, -1, 1, 2, 2, 1, -1} vì số lần xuất hiện mỗi phần tử trong mảng là
// F = {3, 3, 2, 1, 1, 2, 3} vì vậy phần tử A[0] = 1 có số lần xuất hiện là 3
// và không có phần tử nào xuất hiện nhiều hơn 3 nên ans[0] = -1,
...
// 		dòng đầu tiên đưa vào số n là số các phần tử của mảng A[];
